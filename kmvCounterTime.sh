...
# gdb --args ./build/apps/run $EXPERIMENT_TYPE $DATASET_FOLDER/comm-linux-kernel-reply.edges 1 $k
...
gdb --args ./build/apps/run $EXPERIMENT_TYPE $DATASET_FOLDER/fb-wosn-friends.edges 0 $k # > $RESULT_FOLDER/fb-wosn-friends.csv
